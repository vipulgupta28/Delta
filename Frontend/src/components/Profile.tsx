...
const Profile = () => {
 ...
 const handleChanges = async () => {
  ...
  try {
    const response = await axios.post("http://localhost:3000/api/v1/handleProfileChanges", formData, {
      headers: {
        ...
        <div className="px-6 pt-20 pb-6">
          ...
          <h1 className="text-2xl font-bold mb-2">{username}</h1>
           <button
              ...
              className="px-4 py-2 hover:cursor-pointer bg-transparent border border-gray-600 text-white font-medium rounded-full hover:bg-gray-900 transition-colors"
            >
              Edit profile
            </button>
             </div>
